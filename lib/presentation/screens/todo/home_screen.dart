...
import 'package:detailed__riverpod_app/presentation/screens/todo/state/todo_state.dart';
...
import '../../widgets/app_text_input_field.dart';
...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (authState.status == AuthStatus.authenticated &&
          authState.user != null) {
        ref.read(todoControllerProvider.notifier).loadTodos(authState.user!.id);
      }
    });
  }
  ...
  Widget _buildTodoCard(TodoEntity todo, String userId) {
    final isOverdue =
        todo.dueDate != null &&
  ...
  void _showTodoOptionsBottomSheet(TodoEntity todo, String userId) {
  ...
  void _showDeleteDialog(TodoEntity todo, String userId) {
    showDialog(
      context: context,
