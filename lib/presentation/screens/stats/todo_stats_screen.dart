import 'package:detailed__riverpod_app/presentation/screens/stats/state/stats_state.dart';
...
class TodoStatsScreen extends ConsumerWidget {
  ...
  Widget _buildPriorityChart(List<TodoEntity> todos) {
  ...
  Widget _buildStatusChart(List<TodoEntity> todos) {
  ...
  Widget _buildRecentActivity(List<TodoEntity> todos) {
  ...
  Widget _buildPerformanceMetrics(List<TodoEntity> todos) {
