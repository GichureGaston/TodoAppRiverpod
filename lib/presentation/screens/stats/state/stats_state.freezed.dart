...
mixin _$StatsState {
 ...
 bool get isLoading; String? get errorMessage; DateTime? get lastErrorTime; TodoStats? get stats;
...
@override
int get hashCode => Object.hash(runtimeType,isLoading,errorMessage,lastErrorTime,stats);

@override
String toString() {
  return 'StatsState(isLoading: $isLoading, errorMessage: $errorMessage, lastErrorTime: $lastErrorTime, stats: $stats)';
}
...
@useResult
$Res call({
 bool isLoading, String? errorMessage, DateTime? lastErrorTime, TodoStats? stats
});
...
/// Create a copy of StatsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isLoading = null,Object? errorMessage = freezed,Object? lastErrorTime = freezed,Object? stats = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isLoading,  String? errorMessage,  DateTime? lastErrorTime,  TodoStats? stats)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StatsState() when $default != null:
return $default(_that.isLoading,_that.errorMessage,_that.lastErrorTime,_that.stats);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isLoading,  String? errorMessage,  DateTime? lastErrorTime,  TodoStats? stats)  $default,) {final _that = this;
switch (_that) {
case _StatsState():
return $default(_that.isLoading,_that.errorMessage,_that.lastErrorTime,_that.stats);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isLoading,  String? errorMessage,  DateTime? lastErrorTime,  TodoStats? stats)?  $default,) {final _that = this;
switch (_that) {
case _StatsState() when $default != null:
return $default(_that.isLoading,_that.errorMessage,_that.lastErrorTime,_that.stats);case _:
  return null;
...
class _StatsState extends StatsState {
   _StatsState({this.isLoading = false, this.errorMessage, this.lastErrorTime, this.stats}): super._();
  

@override@JsonKey() final  bool isLoading;
@override final  String? errorMessage;
@override final  DateTime? lastErrorTime;
@override final  TodoStats? stats;
...
/// Create a copy of StatsState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isLoading = null,Object? errorMessage = freezed,Object? lastErrorTime = freezed,Object? stats = freezed,}) {
